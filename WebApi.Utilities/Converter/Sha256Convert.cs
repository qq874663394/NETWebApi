...
{
    public class Sha256Convert : Newtonsoft.Json.JsonConverter
    {
        ...
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
            ...
            byte[] bs = SHA256.Create().ComputeHash(System.Text.Encoding.UTF8.GetBytes(value.ToString()));
            writer.WriteValue(bs.ToHexStr());
        }
    }
}
